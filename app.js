...
const DEFAULT_LOGO = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 120" width="400" height="120"><rect width="100%" height="100%" fill="none"/><circle cx="50" cy="60" r="36" fill="%230E2A5E" stroke="%232F6FE0" stroke-width="3"/><path d="M50 32 V88 M36 46 H64 M36 74 H64" stroke="%235FA8E0" stroke-width="4" stroke-linecap="round"/><circle cx="50" cy="60" r="10" fill="%23FFFFFF"/><text x="100" y="55" font-family="'Segoe UI', Arial, sans-serif" font-weight="800" font-size="28" fill="%230E2A5E" letter-spacing="1">DANISH</text><text x="100" y="80" font-family="'Segoe UI', Arial, sans-serif" font-weight="600" font-size="16" fill="%232F6FE0" letter-spacing="3">HEALTH CARE</text></svg>`;
